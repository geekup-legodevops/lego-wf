...
(
    ...
    curl --remote-name-all --silent --show-error \
        https://raw.githubusercontent.com/geekup-legodevops/lego-wf/feature/test-self-hosted-installation-script-testing/deploy/template/docker-compose.yml.sh \
        https://raw.githubusercontent.com/geekup-legodevops/lego-wf/feature/test-self-hosted-installation-script-testing/deploy/template/mongo-init.js.sh \
        https://raw.githubusercontent.com/geekup-legodevops/lego-wf/feature/test-self-hosted-installation-script-testing/deploy/template/docker.env.sh \
        https://raw.githubusercontent.com/geekup-legodevops/lego-wf/feature/test-self-hosted-installation-script-testing/deploy/template/nginx_app.conf.sh \
        https://raw.githubusercontent.com/geekup-legodevops/lego-wf/feature/test-self-hosted-installation-script-testing/deploy/template/encryption.env.sh
